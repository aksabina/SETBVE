...
- **data/**: Contains example data from SETBVE experimental runs, including evaluation results (RPD and RAC) for each run.
...
│   ├── eval_stats/...      # Evaluation results RPD and RAC
|   ├── README.md
